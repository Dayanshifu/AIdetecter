...
#######################################
# 需要的第三方库(python3x):
# python3-tk(apt) 或 tk (pacman)
# python3-pil(apt) 或 python-pillow(pacman)
# python3-pil.imagetk(apt)
# requests==2.28.1(pip)
...
aibtn = Button(btnFrame, text='智能识别', font=('微软雅黑',12), command=lambda:setTxt(ai.ai(f2b64(imagePath))))
